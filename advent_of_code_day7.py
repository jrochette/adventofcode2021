...
sorted_crab_positions = list(crab_positions)
sorted_crab_positions.sort()

min_position = sorted_crab_positions[0]
max_position = sorted_crab_positions[-1]

available_positions = range(min_position, max_position + 1)

fuel_usage_totals = {}
for position in available_positions:
    for crab_position in crab_positions:
        # part 1
        # fuel_usage_totals[position] = fuel_usage_totals.get(position, 0) + (
        #    abs(position - crab_position)
        # )
        # part 2
        fuel_usage_totals[position] = fuel_usage_totals.get(position, 0) + (
